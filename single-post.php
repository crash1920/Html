                    ...
                    <div class="classynav">
                        <ul>
                           ...
                           <ul> 
                            ...
                            <li class="active"><a href="single-post.php">Single Articles</a></li>
                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                        ...
                        <div class="pager d-flex align-items-center justify-content-between">
                            ...
                            <div class="next">
                                <a href="next1.html">Next <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="comment_area clearfix">
                                   ...
                                   echo(" <h5 class='title'>".$count." comments </h5>");
                                        ...
                                        <li class='single_comment_area'>
                                            ...
                                            <div class='comment-content d-flex'>
                                                ...
                                                <div class='comment-author'>
                                                    <img src='img/bg-img/29.jpg' alt='author'>
                                                </div>
                                                <!-- Comment Meta -->
                                                <div class='comment-meta'>
                                                    <a href='#' class='post-author'>".$data[0]."</a>
                                                    <a href='#' class='post-date'>". $data[3] ."</a>
                                                    <p>".$data[2]."</p>
                                                </div>
                                            </div>
                                        </li>
