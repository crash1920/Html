    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form" method="Post" action="reg-trait.php" >
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter  first name">
						<input class="input100" type="text" name="first-name" required>
						<span class="focus-input100" data-placeholder="First name"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter second name ">
						<input class="input100" type="text" name="second-name" required>
						<span class="focus-input100" data-placeholder="Second name"></span>
					</div>
                    <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "age ">
						<input class="input100" type="number" name="age" required>
