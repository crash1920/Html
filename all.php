                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                   ...
                                   <ul> 
                                    <li class="active"><a href="all.php">all Articles</a></li>
                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                        ...
                        <?php  require_once("cnx.php") ; 
                            ...
                            <div class='post-data'>
                                <a href='#' class='post-catagory'>".$data[2]."</a>
                                <a href='#' class='post-title'>
                                    <h6>".$data[0]."</h6>
                                </a>
                                <div class='post-meta'>
                                    <p class='post-author'>By <a href='#'>".$data[1]."</a></p>
                                    <p class='post-excerp'>".$data[3]."</p>
