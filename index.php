                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100" src="nad.jpg" alt="Second slide">
                          </div>
                          <div class="carousel-item">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-video-post">
                        <img src="img/bg-img/cintd.jpg" alt="">
                        <!-- Video Button -->
                        <div class="videobtn">
                            <a href="vid.mp4" class="videoPlayer"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-video-post">
                        <img src="img/bg-img/ca.jpg" alt="">
                        <!-- Video Button -->
                        <div class="videobtn">
                            <a href="Globe damour.mp4" class="videoPlayer"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-video-post">
                        ...
                        <!-- Video Button -->
                        <div class="videobtn">
                            <a href="vid2.mp4" class="videoPlayer"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
